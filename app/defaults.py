...
DEFAULTS = {
    ...
    # ── Shell ─────────────────────────────────────────────────────────────────
    "shell": {
        "provider": "bash",            # zsh | bash | fish | nushell | ...
        "command":  "bash",            # actual binary to exec (set by setup)
        "scrollback": 10000,
    },

    # ── Editor ────────────────────────────────────────────────────────────────
    "editor": {
        "provider": "builtin",         # builtin | nano | nvim | vim | code | ...
        "command":  "nano",            # actual binary to exec (set by setup)
        "terminal": True,              # True = launch inside embedded terminal
        "tab_size": 4,
        "word_wrap": False,
        "line_numbers": True,
    },
    ...
    # ── Terminal emulator ─────────────────────────────────────────────────────
    "terminal": {
        "emulator": "",                # e.g. kitty | alacritty (set by setup)
    },

    # ── UI / startup ──────────────────────────────────────────────────────────
    "ui": {
        "start_path": "~",            # directory the explorer opens to
        "theme": "dark",
    },
